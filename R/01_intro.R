...
sqrt(10)
round(3.14159)
args(round) # arguments of the function
?round
??krustal ## when you do not know the name of the function.
print("Hi!")
print("Hello, world!")


## ----datatypes----------------------------------------------------------------
animals  <- c("mouse", "rat", "dog", "cat") # vector
...
# Factor : Vector resenting categorical variables and thus having levels.
animals
